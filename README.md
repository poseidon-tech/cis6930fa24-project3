...
1. **Clustering by Day and Time:** A heatmap providing insights into how incidents are distributed across different days of the week and times of the day, with each cell representing the number of incidents for a specific combination of day and time (e.g., Monday morning, Friday night). The intensity of the color corresponds to the frequency of incidents, making it easy to identify high-incident periods such as weekends or evening hours. This visualization is particularly useful for identifying temporal patterns in incident occurrences and planning resource allocation accordingly.
...
3. **Incidents Over Time:** A line chart that shows the trend of incidents recorded over a period of days, with the x-axis representing the dates and the y-axis showing the number of incidents for each date. This visualization highlights trends such as spikes or drops in incident counts during specific periods (e.g., holidays, weekends), providing valuable insights for trend analysis and resource planning to mitigate future surges..
4. **Pie Chart of Incidents by Day:** This pie chart breaks down the proportion of incidents by the day of the week, with each slice representing the percentage of incidents occurring on a specific day and labels showing percentages for clarity. It offers a quick and clear visual representation of which days experience the most or least incidents, enabling better scheduling and resource allocation for days with higher activity.
